// NEW FILE: frontend/src/services/financial_api.js
// API service for financial management system
...
const financialApi = {
  ...
  calculatePayments: async (periodId, stageId) => {
    const response = await api.post(`/calculate-payments/${periodId}/${stageId}`);
    return response.data;
  },
